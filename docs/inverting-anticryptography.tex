...
\begin{quote}
Freitas sets out a \textbf{Principle of Anticryptography}: a beacon message
should be optimised for easy decoding by its recipients, using simple, highly
redundant coding with abundant clues---the opposite objective to that of secret
code-making.~\cite{xenology}
\end{quote}
...
\bibitem{xenology} Freitas, R.A. Jr.: Xenology: An Introduction to the
Scientific Study of Extraterrestrial Life, Intelligence, and Civilization. 1st
edn., \S24.2.4 ``Alien Message Contents'' (1979)
...
\bibitem{decrypt} Heller, R.: Decryption of messages from extraterrestrial
intelligence using the power of social media --- the SETI Decrypt Challenge.
International Journal of Astrobiology \textbf{18}(4), 296--303 (2019).
arXiv:1706.00653, doi:10.1017/S1473550417000568
